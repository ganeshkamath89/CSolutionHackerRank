...
long taumBday(int b, int w, int bc, int wc, int z) {
    long bcConvert = bc*((long)(((long)w)+b)) + ((long)w)*z;
    long wcConvert = wc*(((long)w)+((long)b)) + ((long)b)*z;
    long minConvert = bcConvert < wcConvert ? bcConvert : wcConvert;
    long noConvert = ((long)b)*bc + ((long)w)*wc;
    long min = minConvert < noConvert ? minConvert : noConvert;
    return min;
}
